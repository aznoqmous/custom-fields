...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return CustomFields; });\n/* harmony import */ var _custom_select__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./custom-select */ \"./src/custom-select.js\");\n/* harmony import */ var _custom_input_text__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./custom-input-text */ \"./src/custom-input-text.js\");\n/* harmony import */ var _custom_textarea__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./custom-textarea */ \"./src/custom-textarea.js\");\n/* harmony import */ var _custom_input_number__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./custom-input-number */ \"./src/custom-input-number.js\");\n/* harmony import */ var _custom_input_checkbox__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./custom-input-checkbox */ \"./src/custom-input-checkbox.js\");\n/* harmony import */ var _custom_input_radio__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./custom-input-radio */ \"./src/custom-input-radio.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nclass CustomFields {\r\n    constructor(selector='input,select,textarea', config={}){\r\n        this.selector = selector\r\n        this.className = 'custom-element'\r\n        this.config = config\r\n        this.build()\r\n        this.bindObserver()\r\n    }\r\n\r\n    bindObserver(){\r\n        this.observer = new MutationObserver(()=>{\r\n            this.build()\r\n        })\r\n        this.observer.observe(document.body, {\r\n            attributes: false,\r\n            childList: true,\r\n            subtree: true\r\n        })\r\n    }\r\n\r\n    build(){\r\n        this.els = [...document.querySelectorAll(this.selector)]\r\n        this.els.map(el => {\r\n            // already bound\r\n            if(el.parentElement.classList.contains(this.className)) return false;\r\n\r\n            let customEl = null\r\n\r\n            if(el.tagName == 'INPUT' && el.type == 'text') customEl = new _custom_input_text__WEBPACK_IMPORTED_MODULE_1__[\"default\"](el)\r\n            if(el.tagName == 'TEXTAREA') customEl = new _custom_textarea__WEBPACK_IMPORTED_MODULE_2__[\"default\"](el)\r\n            if(el.tagName == 'INPUT' && el.type == 'number') customEl = new _custom_input_number__WEBPACK_IMPORTED_MODULE_3__[\"default\"](el)\r\n            if(el.tagName == 'INPUT' && el.type == 'checkbox') customEl = new _custom_input_checkbox__WEBPACK_IMPORTED_MODULE_4__[\"default\"](el)\r\n            if(el.tagName == 'INPUT' && el.type == 'radio') customEl = new _custom_input_radio__WEBPACK_IMPORTED_MODULE_5__[\"default\"](el)\r\n            if(el.tagName == 'SELECT') customEl = new _custom_select__WEBPACK_IMPORTED_MODULE_0__[\"default\"](el)\r\n\r\n            if(!customEl) return false;\r\n\r\n            for(let key in this.config) customEl[key] = this.config[key]\r\n        })\r\n    }\r\n\r\n}\r\n\n\n//# sourceURL=webpack:///./src/custom-fields.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return CustomInputText; });\n/* harmony import */ var _custom_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./custom-element */ \"./src/custom-element.js\");\n\r\n\r\nclass CustomInputText extends _custom_element__WEBPACK_IMPORTED_MODULE_0__[\"default\"] {\r\n    constructor(el){\r\n        super(el, 'custom-input-text')\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack:///./src/custom-input-text.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return CustomInputText; });\n/* harmony import */ var _custom_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./custom-element */ \"./src/custom-element.js\");\n\r\n\r\nclass CustomInputText extends _custom_element__WEBPACK_IMPORTED_MODULE_0__[\"default\"] {\r\n    constructor(el){\r\n        super(el, 'custom-input-textarea')\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack:///./src/custom-textarea.js?");
